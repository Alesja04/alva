...
export default function Menu() {
  return (
    ...
    <h1 style={{ textAlign: 'center', paddingTop: 50}}>MENÜÜ</h1>
      ...
      <Col style={{ paddingTop: 15}} ><a href='/pasta'><img src="./img/pasta.png" alt='logo'  width={600} height={300}/></a></Col>
      <Col sm="6"><a href='/suupisted'><img src="./img/suupisted.png" alt='logo' width={590} height={320}/></a></Col>
      </Row>
