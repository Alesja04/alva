    ...
    export default function Reserveerimine() {
        ...
        return (
            <Container style={{
              ...
              <Row>
              <Col sm="6"><h1 style={{ textAlign: 'center', paddingTop: 50, paddingRight: 250}}>RESERVEERIMINE</h1>

              <p style={{fontSize: 28, textAlign: 'justify', paddingTop: 50, paddingRight: 30}}>
                LÕUNASÖÖK<br />
                Laupäev ja pühapäev<br />
                Broneerimine kell 12.00-13.30<br />
                <br /><br />
                ÕHTUSÖÖK<br />
                Neljapäevast Pühapäevani<br />
