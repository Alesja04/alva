...
export default function Home(){
    ...
    return(
        <>     
            <Navbar sticky='top' expand="md"  variant="white" className="justify-content-center" 
            style={{backgroundColor: '#F5F5F5'}}>
            <Nav>
            
                <Nav.Link onClick={scrollToTop}><img src="./img/logo.png" alt='logo' width={130} height={50}/></Nav.Link>
                ...
                <Nav.Link><img src="./img/tar.png" alt='logo' width={60} height={50}/></Nav.Link>
